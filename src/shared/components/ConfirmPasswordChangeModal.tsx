              ...
              <div>
                ...
                <div className="mt-4 p-3 bg-amber-50 rounded-lg border border-amber-100">
                  <p className="text-sm text-amber-900">
                    <span className="font-semibold">Important :</span> Après avoir
                    changé votre mot de passe, vous devrez utiliser le nouveau
                    mot de passe pour vous connecter à votre compte.
                  </p>
                </div>
              </div>
            </div>

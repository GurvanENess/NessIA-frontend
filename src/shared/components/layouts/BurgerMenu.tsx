      ...
      >
        ...
        <nav className="p-4 flex-1 overflow-y-auto">
          <div className="space-y-2">
            ...
            {/* Standalone Help Item */}
            <div className="pt-2 border-t border-gray-100 mt-4">
              <button
                onClick={handleItemClick}
                className="w-full flex items-center gap-3 px-3 py-3 text-gray-600 hover:text-[#7C3AED] hover:bg-purple-50 rounded-lg transition-colors group"
              >
                <HelpCircle className="w-5 h-5 group-hover:text-[#7C3AED] transition-colors" />
                <span>Aide</span>
              </button>
            </div>
            ...
            {isAuthenticated && (
              <div className="pt-2">
                <button
                  ...
                  className="w-full flex items-center gap-3 px-3 py-3 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors group"
                >

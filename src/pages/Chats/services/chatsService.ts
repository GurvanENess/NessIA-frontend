...
const mockChats: ChatConversation[] = [
  {
    ...
    lastMessage: 'Parfait ! J\'ai généré un post Instagram pour votre collection estivale avec des couleurs vibrantes. Le contenu met l\'accent sur la fraîcheur et l\'élégance de vos nouvelles pièces.',
  ...
  },
  {
    ...
    lastMessage: 'J\'ai préparé une campagne de promotion flash pour ce weekend. Le post Facebook est programmé avec un visuel accrocheur et un call-to-action efficace pour maximiser les conversions.',
  ...
  },
  {
    ...
    lastMessage: 'Nous avons exploré les tendances automne ensemble. Le brouillon TikTok capture parfaitement l\'esprit cocooning de la saison avec des couleurs chaudes et des textures douillettes.',
  ...
  },
  {
    ...
    lastMessage: 'Excellent ! Le post Instagram behind-the-scenes est maintenant publié. Les coulisses de votre séance photo vont captiver votre audience et renforcer l\'authenticité de votre marque.',
  ...
  },
  {
    ...
    lastMessage: 'J\'ai créé un guide complet sur le port des imprimés cette saison. Le contenu Twitter est prêt avec des conseils pratiques de vos stylistes pour engager votre communauté.',
  ...
  },
  {
    ...
    lastMessage: 'Nous avons exploré plusieurs concepts pour votre campagne printemps. J\'ai quelques idées créatives à vous proposer pour des posts qui marqueront les esprits.',
  ...
  },
  {
    ...
    lastMessage: 'Analysons ensemble vos métriques Instagram. Je peux vous aider à créer du contenu plus engageant basé sur les préférences de votre audience.',
